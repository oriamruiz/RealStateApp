...
namespace RealStateApp.WebApp.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> ChangeStatusPost(string Id)
        {
            ...
            return RedirectToRoute(new { controller = "AdminHome", action = "Admins" });
        }
        ...
        {
            return View(await _userService.GetByIdUpdateAdminViewModelAsync(Id));
        }

        [HttpPost]
        public async Task<IActionResult> Update(UpdateAdminViewModel vm)
        {
            if (!ModelState.IsValid)
            {
                return View(vm);
            ...
            var response = await _userService.UpdateAdminAsync(vm);
